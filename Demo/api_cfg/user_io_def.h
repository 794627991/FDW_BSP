...
#define EPROM_POWER_DIR OutputIO(IIC_EN_GPIO, IIC_EN_PIN, 0)
#define EPROM_POWER_ON GPIO_ResetBits(IIC_EN_GPIO, IIC_EN_PIN) //24WC02供电
#define EPROM_POWER_OFF GPIO_SetBits(IIC_EN_GPIO, IIC_EN_PIN)  //24WC02断电
