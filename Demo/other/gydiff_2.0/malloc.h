...
#define MEM_MAX_SIZE 20 * 1024							   /* 最大管理内存 nK */
...
#define Malloc_Protect 0x8000				  /* 对内存池map加保护，在set时判断非 Malloc_Protect 值的，清0 */
#define Malloc_ReProtect (Malloc_Protect - 1) /* 该大小需要和 memmap 的数据类型同步，这里memmap类型是u16 */
